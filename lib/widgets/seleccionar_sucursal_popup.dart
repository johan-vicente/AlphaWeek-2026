...
/// Popup para elegir a qué sucursal ir cuando se viene DESDE EL CARRITO
/// (a diferencia del popup del menú lateral, aquí siempre se navega con
/// preguntarPorCarritoAlEntrar: true, porque venimos con productos ya
/// seleccionados).
class SeleccionarSucursalPopup extends StatefulWidget {
  const SeleccionarSucursalPopup({super.key});

  @override
  State<SeleccionarSucursalPopup> createState() => _SeleccionarSucursalPopupState();
}

class _SeleccionarSucursalPopupState extends State<SeleccionarSucursalPopup> {
  ...
  List<Sucursal> get _sucursalesFiltradas {
    ...
    return SucursalesData.sucursales.where((s) => s.nombre.toLowerCase().contains(q)).toList();
  }
        ...
        child: ElevatedButton(
          onPressed: habilitado
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => SirenaMapScreen(
